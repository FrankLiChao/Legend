...
//        
////        _imageView.frame = [_photo.srcImageView convertRect:CGRectMake(DeviceMaxWidth/2, DeviceMaxHeight/2, 0, 0) toView:nil];
//        _imageView.alpha = 0;
//        
//        _imageView.frame = [_photo.srcImageView convertRect:_photo.srcImageView.bounds toView:nil];
//        
...
//    [UIView animateWithDuration:0.35 animations:^{
//        
//        _imageView.frame = [_photo.srcImageView convertRect:CGRectMake(160*widthRate, DeviceMaxHeight/2, 0, 0) toView:nil];
//        _imageView.alpha = 0;
//        
////        _imageView.frame = [_photo.srcImageView convertRect:_photo.srcImageView.bounds toView:nil];
//        
